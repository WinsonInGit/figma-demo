                    ...
                    child: Container(
                      ...
                      Padding(
                          ...
                          child: Obx(() => ListView.separated(
                              ...
                              itemCount: controller.profilePostsOneModelObj
                                  .value.listcontentblockItemList.length,
                              itemBuilder: (context, index) {
                                ListcontentblockItemModel model = controller
                                    .profilePostsOneModelObj
                                    .value
                                    .listcontentblockItemList[index];
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                          ...
                                                                          child: Row(
                                                                              ...
                                                                              mainAxisSize: MainAxisSize.max,
                                                                              children: [
                                                                                Padding(padding: getPadding(bottom: 2), child: Text("lbl_header".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterSemiBold16Black900.copyWith())),
                                                                                Padding(padding: getPadding(top: 4), child: Text("lbl_8m_ago".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterRegular14Gray400.copyWith()))
                                                                              ])),
                                                                      Container(
                                                                          width: getHorizontalSize(
                                                                              260.00),
