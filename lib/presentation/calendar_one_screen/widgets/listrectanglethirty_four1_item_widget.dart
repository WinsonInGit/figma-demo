...
class ListrectanglethirtyFour1ItemWidget extends StatelessWidget {
  ListrectanglethirtyFour1ItemWidget(this.listrectanglethirtyFour1ItemModelObj);

  ListrectanglethirtyFour1ItemModel listrectanglethirtyFour1ItemModelObj;
